...
export class UserService {
 ...
 checkEmailExists(email: string): Observable<any> {
  ...
  CalculateFNFTDSAmountByUserId(id: string): Observable<any> {
    return this.http.get<any>(`${environment.apiUrlDotNet}/payroll/calculate-total-fnf-tds-amount/${id}`, this.httpOptions);
  }
