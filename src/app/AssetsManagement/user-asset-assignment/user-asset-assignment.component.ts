...
@Component({
  selector: 'app-user-asset-assignment',
  templateUrl: './user-asset-assignment.component.html',
  styleUrls: ['./user-asset-assignment.component.css']
})
export class UserAssetAssignmentComponent implements OnInit {
  userId:string;
